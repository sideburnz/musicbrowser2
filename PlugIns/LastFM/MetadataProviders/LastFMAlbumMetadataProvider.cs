...
namespace MusicBrowser.Engines.Metadata
{
    class LastFMAlbumMetadataProvider : baseMetadataProvider
    {
        ...
        protected override ProviderOutcome DoWork(baseEntity dto)
        {
            ...
            albumDTO.Username = (Util.Config.GetStringSetting("Internet.LastFMUserName"));
            albumDTO.Language = Util.Localization.LanguageNameToCode(Util.Config.GetStringSetting("Language"));
            ...
            if (albumDTO.Plays > workingDTO.PlayState.TimesPlayed)
            {
                workingDTO.PlayState.TimesPlayed = albumDTO.Plays;
            }
