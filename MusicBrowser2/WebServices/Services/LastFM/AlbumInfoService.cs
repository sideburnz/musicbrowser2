...
namespace MusicBrowser.WebServices.Services.LastFM
{
    ...
    class AlbumInfoService : IWebService
    {
        ...
        {
#if DEBUG
            Logging.LoggerFactory.Verbose("LastFM.AlbumInfoService", "start");
#endif
            ...
            _provider.URL = "last.fm - album info - album=" + localDTO.Album + "&artist=" + localDTO.Artist + "&mbid=" + localDTO.MusicBrainzID;
