...
namespace MusicBrowser.WebServices.Services.LastFM
{
    ...
    class TrackInfoService : IWebService
    {
        ...
        {
#if DEBUG
            Logging.LoggerFactory.Verbose("LastFM.TrackInfoService", "start");
#endif
            ...
            else
            {
                ...
                Logging.LoggerFactory.Debug(string.Format("Last.fm track lookup for \"{0}\" returned this error - {1}", localDTO.Track, localDTO.Error));
            }
